          ...
          <form @submit.prevent="submit(service.id)">
            <div class="d-flex justify-content-end mb-3">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <span class="nav-link active">Under Repair</span>
                </li>
                <li class="nav-item">
            ...
            <div class="ml-3">
              ...
              <button class="btn btn-dark btn-md mb-5 ml-3" type="submit">End Repair</button>
              <button
                type="button"
              ...
              <ul class="dropdown-menu">
                ...
                <li v-if="props.existingQuotationId==null">
...
function cancelRepair(id) {
  router.get("/services/cancelled-under-repair/"+id);
}
