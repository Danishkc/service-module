      ...
      <div class="card">
        <div class="card-body">
          <form @submit.prevent="submit">
            ...
            </div>--><button class="btn btn-dark btn-md mb-5" onclick="window.history.back();">
  Go Back
</button>
            <button type="submit" class="btn btn-dark btn-md mb-5 ml-3">Confirm</button>
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <div class="row">
...
const part1 = props.serviceQuotationLines
...
const form = useForm({
  service_id: props.serviceQuotation.service_id,
  quotation_id: props.quotation_id,
  cus_id: props.serviceQuotation.cus_id,
  place_of_supply: "kerala" || null,
  gst: "consumer" || null,
  invoice_date: new Date().toISOString().substr(0, 10) || null,
  payment_reference: "",
  due_date: "",
  payment_terms: "",
  total: 0,
